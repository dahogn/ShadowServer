...
public class ClassUtils {
    ...
    private static final String JAVA_FILE_PATH = "src/main/java/com/runhang/shadow/demo/device/";    // java文件路径
    public static final String PACKAGE_NAME = "com.runhang.shadow.demo.device";  // 动态类的包名
    ...
    public static String generateCode(String className, Map<String, String> propertyMap) {
        String codeStr = "package " + PACKAGE_NAME + ";\n" +  // 包
